...
<template>
  <div>
    <div class="font-medium block after:content-['*'] after:text-[#E21717] mb-2">{{ label }}</div>
    <label :for="id"
    ...
    <div
      ...
      <div class="flex items-center gap-2">
        <svg class="text-[#080808] size-5" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor"
          viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <path stroke-linecap="round" stroke-linejoin="round"
            d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z">
          </path>
        </svg>
        <div class="text-[#0433FF] font-medium text-sm underline">Foto_Identitas_KTP.png</div>
      </div>
